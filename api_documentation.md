...
```
GET http://192.168.0.2:88/worktime
```

**Get work data for a range:**
```
GET http://192.168.0.2:88/work-data?startDate=2025-11-01&endDate=2025-11-30
```

**Set target hours:**
```
GET http://192.168.0.2:88/setTargetHours?hours=45
```
